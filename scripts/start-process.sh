...
docker pull 207567793991.dkr.ecr.us-east-1.amazonaws.com/mynodeapp:latest

# Stop and remove the current container
docker rm -f $container_name

# Creating and starting a docker container using a new image
docker run -d -p 3000:3000 --name $container_name 207567793991.dkr.ecr.us-east-1.amazonaws.com/mynodeapp:latest
